 ...
 *  is used at the class level and allows the class to handle 
...
public class ProductRestController {
	...
	/*@PathVariable annotation  indicates that a method parameter should be bound to a 
 ...
 // @RequestBody annotation automatically deserializes the JSON into a Java type
  ...
  //In PostMan -DELETE - http://localhost:8085/ims/api/products/9
