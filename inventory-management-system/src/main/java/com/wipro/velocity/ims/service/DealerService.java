...
Spring context will auto detect these classes when annotation-based 
configuration and class path scanning is used.
*/

/*
@Transactional annotation provides broad support 
for transaction management and allows developers
 to concentrate on business logic rather than worrying
...
In spring boot application, all loaded beans are eligible for auto wiring to another
bean.
