...
public class StringBuilderDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("The original string String :" + s1 +", The modified String : "+s2);
		...
		System.out.println(sb1 +"---Inserting at the 19th position ");

		sb1.append(" of Western Ghats");
		System.out.println(sb1 +"---Apppend");
		...
		System.out.println("The string sb after replacing :"+sb1);

		String s4=sb1.substring(10,28);
		System.out.println("The substring of sb1 is :"+s4);
